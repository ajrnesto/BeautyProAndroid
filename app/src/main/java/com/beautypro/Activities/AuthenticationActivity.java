...
public class AuthenticationActivity extends AppCompatActivity {
    ...
    TextInputEditText etSignupFirstName, etSignupLastName, etMobile, etAddressPurok, etAddressBarangay, etAddressMunicipality, etSignupEmail, etSignupPassword;
    ...
    private void initializeViews() {
        ...
        etAddressMunicipality = findViewById(R.id.etAddressMunicipality);
    ...
    private void validateRegistrationForm() {
        if (etSignupFirstName.getText().toString().isEmpty() ||
                ...
                etAddressMunicipality.getText().toString().isEmpty() ||
        ...
        String addressMunicipality = etAddressMunicipality.getText().toString().toUpperCase();
        ...
        userInfo.put("addressMunicipality", addressMunicipality);
