...
public class Utils {
    ...
    public static double calculateRating(HashMap<String, Object> rating) {
        double totalRatingScore = Integer.parseInt(rating.get("oneStars").toString());
        totalRatingScore += Integer.parseInt(rating.get("twoStars").toString()) * 2;
        totalRatingScore += Integer.parseInt(rating.get("threeStars").toString()) * 3;
        totalRatingScore += Integer.parseInt(rating.get("fourStars").toString()) * 4;
        totalRatingScore += Integer.parseInt(rating.get("fiveStars").toString()) * 5;

        double numberOfRatings = Integer.parseInt(rating.get("oneStars").toString());
        numberOfRatings += Integer.parseInt(rating.get("twoStars").toString());
        numberOfRatings += Integer.parseInt(rating.get("threeStars").toString());
        numberOfRatings += Integer.parseInt(rating.get("fourStars").toString());
        numberOfRatings += Integer.parseInt(rating.get("fiveStars").toString());
