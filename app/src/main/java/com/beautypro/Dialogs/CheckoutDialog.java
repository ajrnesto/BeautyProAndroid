            ...
            public void onClick(View view) {
                ...
                if (radDelivery.isChecked()) {
                    if (purok.isEmpty() || barangay.isEmpty() || city.isEmpty()) {
                        Utils.simpleDialog(requireContext(), "Incomplete Address", "Please complete your delivery address.", "Okay");
                ...
                .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            String purok = user.get("addressPurok").toString();
                            String barangay = user.get("addressBarangay").toString();
